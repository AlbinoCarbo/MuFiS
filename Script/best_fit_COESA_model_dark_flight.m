...
%
% By A. Carbognani (OAVdA), 22 febbraio 2019

function [rho_zero_best, Hs_best ] = best_fit_COESA_model_dark_flight(H)
...
title('Test plot: atmospheric models dark flight - Exponential vs COESA (1976)','FontSize',20)
hold off
